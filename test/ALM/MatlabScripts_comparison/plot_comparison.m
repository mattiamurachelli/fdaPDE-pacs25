...
data_OUR = readtable( ...
    '../lagrangian_test1.csv', ...
    'ReadVariableNames', true, ...
    'Delimiter', ',');

data_NLOPT = readtable( ...
    '../lagrangian_test1_nlopt.csv', ...
    'ReadVariableNames', true, ...
    'Delimiter', ',');
...
saveas(FailurePlot, ...
       fullfile(folder, 'LagrangianTest1_FailureHistogram.png'));
...
saveas(IterPlot, ...
       fullfile(folder, 'LagrangianTest1_IterEvalComparison.png'));
...
saveas(CompTimePlot, ...
       fullfile(folder, 'LagrangianTest1_CompTimeComparison.png'));
...
saveas(DistBetweenPlot, ...
       fullfile(folder, 'LagrangianTest1_DistBetweenComparison.png'));
