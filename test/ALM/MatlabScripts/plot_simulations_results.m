...
%% OUR ALM VS MIT LBFGSB OPTIMIZER
%% ============================================================
...
group_iter = [
    ...
    repmat({'OUR-ALM'}, length(OUR_NumIter), 1)
];
...
group_time = [
    ...
    repmat({'OUR-ALM'}, length(OUR_CompTime), 1)
];
...
group_distsol = [
    ...
    repmat({'OUR-ALM'}, length(OUR_DistSol), 1)
];
...
group_between = ...
    repmat({'OUR-ALM'}, length(DistBetween_valid), 1);
