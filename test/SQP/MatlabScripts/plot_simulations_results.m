...
group_iter = [
    ...
    repmat({'OUR-SQP'}, length(OUR_NumIter), 1)
];
...
group_time = [
    ...
    repmat({'OUR-SQP'}, length(OUR_CompTime), 1)
];
...
group_distsol = [
    ...
    repmat({'OUR-SQP'}, length(OUR_DistSol), 1)
];
...
group_between = ...
    repmat({'OUR-SQP'}, length(DistBetween_valid), 1);
