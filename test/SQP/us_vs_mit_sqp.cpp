// CODE TO TEST THE PERFORMANCE OF OUR SQP METHOD IMPLEMENTATION
...
int main() {
    ...
    std::ofstream file("SQP/simulations_rosenbrock.csv");
    ...
    for(int i=0; i < num_simulations; ++i) {
        ...
        solver_our.solve(obj, constraints, x0);
        // Stop timer (OUR)
        ...
        if(i==num_simulations-1) {
            std::ofstream traj_("SQP/trajectory_rosenbrock.csv");
